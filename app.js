...
const APP_VERSION = "2026-06-17.14";
...
const richLifeSceneParts = {
  travel: {
    identities: ["能自由旅行的人", "可以舒服出行的人", "有选择权旅行的人", "把世界当成课堂的人", "不被机票价格困住的人"],
    scenes: [
  ...
  support: {
    identities: ["不用被琐事拖住的人", "把生活安排得很轻松的人", "有生活支持系统的人", "把精力留给重要事情的人", "被生活好好支持的人"],
    scenes: [
  ...
  learning: {
    identities: ["有时间学习世界的人", "可以慢慢学语言和文化的人", "把旅行变成学习的人", "用财富扩大理解力的人", "可以认真培养兴趣的人"],
    scenes: [
  ...
  giving: {
    identities: ["有能力慷慨的人", "可以稳定捐钱的人", "让钱也服务善意的人", "能把善良变成系统的人", "有余力照亮别人的人"],
    scenes: [
  ...
  assets: {
    identities: ["有被动收入的人", "让钱慢慢替我工作的人", "资产越来越清楚的人", "不再只靠工资的人", "有长期选择权的人"],
    scenes: [
  ...
  body: {
    identities: ["有时间照顾身体的人", "健康又自由的人", "把身体放在第一位的人", "有能量享受财富的人", "身体和心都稳定的人"],
    scenes: [
